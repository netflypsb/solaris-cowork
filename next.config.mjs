        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.clerk.accounts.dev https://clerk.accounts.dev https://js.stripe.com blob:",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: https: blob: https://*.clerk.accounts.dev https://img.clerk.com",
              "font-src 'self' data:",
              "connect-src 'self' https: wss: https://*.clerk.accounts.dev https://clerk.accounts.dev https://api.stripe.com",
